from dual_runner import Ui_SteganoGAN
from PyQt5.QtWidgets import QApplication,QWidget
import  sys
from PyQt5 import QtCore
import sys

class GAN_show(QWidget,Ui_SteganoGAN):  #继承类
    def __init__(self):
        super().__init__()
        ...
        self.information_input_text.setStyleSheet('''
                                     QLineEdit
                                     {text-align : center;
                                     background-color : rgb(60,63,65);
                                     font: bold;
        ...
        self.information_input_label.setStyleSheet('''
                                             QLabel
                                             {text-align : center;
                                             font: bold;
                                             border: None;
                                             ...
                                             ''')
        self.information_output_text.setStyleSheet('''
                                             QLineEdit
                                             {text-align : center;
                                             background-color : rgb(60,63,65);
                                             font: bold;
        ...
        self.information_output_label.setStyleSheet('''
                                                     QLabel
                                                     {text-align : center;
                                                     font: bold;
                                                     border: None;
